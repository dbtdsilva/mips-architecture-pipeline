...
SC_MODULE( forward )
{
  public:
    ...
    sc_in <bool> Branch;
    // Control signals
    sc_in<bool> RegWrite_exe, RegWrite_mem1, RegWrite_mem2, RegWrite_wb, MemRead_exe, MemRead_mem1, MemRead_mem2, MemRead, MemWrite_exe;
    ...
    SC_CTOR(forward)
    {
        ...
        sensitive << WriteReg_exe << WriteReg_mem1 << WriteReg_mem2 << WriteReg_wb
                  ...
                  << MemRead_exe << MemRead_mem1 << MemRead_mem2 << MemRead
                  << MemWrite_exe;
   }
